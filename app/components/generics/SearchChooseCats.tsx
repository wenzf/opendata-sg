...
export default function SearchChooseCats() {
    ...
    const onDoSearch = (e: BaseSyntheticEvent) => {
        ...
        if (textInputRef.current?.value
            ...
            path += textInputRef.current?.value
    ...
    return (
        <form onSubmit={onDoSearch}>
            ...
            <div className="search_2">
                ...
                <input required aria-required className="inp2" id="search_by_cat" type="search" ref={textInputRef} />
                <button type="submit" className="btn2">
                    <SearchIconSVG width={33} height={33} aria-label="Suche bestätigen" />
                </button>
            </div>
        </form>
    )
